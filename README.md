...
- The projects must use the __same__ supabase project for their authentication. I.e. the supabase credentials must match for the session to be generated between projects.
...
export default defineNuxtConfig({
  ...
  extends: [/* Link to layer to be added after deployment */]
  /* ... The rest of your config ... */
})
```
...
|path|string|'/'|         |
|sameSite|<ul><li>boolean</li><li>"lax"</li><li>"strict"</li><li>"none"</li></ul> |'lax'|         |
